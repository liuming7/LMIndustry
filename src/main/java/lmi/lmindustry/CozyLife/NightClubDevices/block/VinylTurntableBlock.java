package lmi.lmindustry.CozyLife.NightClubDevices.block;
...
public class VinylTurntableBlock extends Block {
    ...
    public VinylTurntableBlock(Properties properties,int west,int east,int north,int south,int bottom,int top,double pixelBit) {
        super(properties);
